/************************ dSPACE target specific file *************************
   ...
   Include file .\observateur_controleur_dspace_imc_rti1104\Observateur_Controleur_Dspace_IMC_th.c :

   Task Configuration file for model : Observateur_Controleur_Dspace_IMC

   RTI1104 6.9.1 (02-Nov-2012)/2.5
   28-Sep-2016 15:55:48
...
/* ===== List of model tasks and assigned interrupt sources ================
   ...
   Timer Task 1 [0.005 0] s       : Timer A interrupt
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\observateur_controleur_dspace_imc_rti1104\Observateur_Controleur_Dspace_IMC_th.c is for ST).
# endif
...
/* Initialize dynamically generated services */
  ...
  rtith_bind_interrupt( /* --- Bind interrupt to task. ----- */
      ...
      pTask1,             /*  Task (TCB pointer).              */
      (0.005 * RTI_TIMER_TASK_TIME_SCALE),             /*  Sample time or period.           */
      C_LOCAL,             /*  RTK channel.                     */
