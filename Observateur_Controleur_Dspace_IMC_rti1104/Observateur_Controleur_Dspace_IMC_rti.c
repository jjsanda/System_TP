/*********************** dSPACE target specific file *************************
   ...
   Include file Observateur_Controleur_Dspace_IMC_rti.c:
...
#define RTB_STRUCTURE_NAME             Observateur_Controleur_Dspace_B
#define RTP_STRUCTURE_NAME             Observateur_Controleur_Dspace_P
...
{
  /* Calls for base sample time: [0.005, 0] */
