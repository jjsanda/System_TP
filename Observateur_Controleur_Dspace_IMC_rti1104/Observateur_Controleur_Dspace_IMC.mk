# =============================================================================
#  FILE:
#    Observateur_Controleur_Dspace_IMC.mk
#
#  DESCRIPTION:
...
#
#  $RCSfile: Observateur_Controleur_Dspace_IMC.mk $ $Revision: 2.56 $ $Date: 2012/08/20 14:26:50MESZ $
#  $ProjectName: e:/ARC/Products/ImplSW/RTISW/RTI/Components/Build/Makefile/project.pj $
# =============================================================================
# NEVER CHANGE THIS LINE:
# RTI_TEMPLATE_MAKEFILE_VERSION = 190
# =============================================================================
...
MAKEFILE                       = Observateur_Controleur_Dspace_IMC.mk
...
MATLAB_ROOT_ALT                = C:\PROGRA~1\MATLAB\R2012b
MATLAB_BIN_ALT                 = C:\PROGRA~1\MATLAB\R2012b\bin
RELEASE_VERSION                = R2012b
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN
MODEL                          = Observateur_Controleur_Dspace_IMC
MODULES                        = Observateur_Controleur_Dspace_IMC_data.c Observateur_Controleur_Dspace_IMC_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTWCUST_INCLUDES = \
	$(START_DIR)\Observateur_Controleur_Dspace_IMC_rti1104 \
	$(START_DIR)
